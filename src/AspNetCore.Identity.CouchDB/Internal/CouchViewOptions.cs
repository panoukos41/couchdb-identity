...
namespace CouchDB.Driver.Types
{
    ...
    /// </summary>
    internal class CouchViewOptions
    {
        /// <summary>
        ...
        /// </summary>
        internal bool? Conflicts { get; set; }

        /// <summary>
        /// Return records starting with the specified key.
        /// </summary>
        internal string? StartKey { get; set; }

        /// <summary>
        /// Stop returning records when the specified key is reached.
        /// </summary>
        internal string? EndKey { get; set; }

        /// <summary>
        ///  Specifies whether the specified end key should
        ///  be included in the result. Default is true.
        /// </summary>
        internal bool? InclusiveEnd { get; set; }
        ...
        /// Ignored if include_docs isn’t true. Default is false.
        /// </summary>
        internal bool? AttEncodingInfo { get; set; }
        ...
        /// </summary>
        internal bool? UpdateSeq { get; set; }
        ...
        /// Ignored if include_docs isn’t true. Default is false.
        /// </summary>
        internal bool? Attachments { get; set; }
        ...
        /// </summary>
        internal string? EndkeyDocId { get; set; }
        ...
        /// </summary>
        internal string? StartkeyDocid { get; set; }
        ...
        internal object ToQueryParameters() => new
        {
