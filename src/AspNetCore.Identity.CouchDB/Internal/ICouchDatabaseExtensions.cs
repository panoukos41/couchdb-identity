...
{
    internal static class ICouchDatabaseExtensions
    {
        internal static Task<CouchViewResult<TValue>> GetViewAsync<T, TValue>(this ICouchDatabase<T> db, string design, string view, CouchViewOptions? options = null, CancellationToken cancellationToken = default)
        ...
        internal static Task<CouchViewResult<TValue, TDoc>> GetViewAsync<T, TValue, TDoc>(this ICouchDatabase<T> db, string design, string view, CouchViewOptions? options = null, CancellationToken cancellationToken = default)
            where T : CouchDocument
    ...
    // https://github.com/matteobortolazzo/couchdb-net/blob/a2f5ad0723ba00f437cb11ccce69ab5ff6f9de91/src/CouchDB.Driver/Helpers/RequestsHelper.cs#L11
